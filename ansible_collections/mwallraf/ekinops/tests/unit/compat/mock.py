...
if sys.version_info >= (3,) and sys.version_info < (3, 4, 4):
    ...
    def _iterate_read_data(read_data):
        ...
        # Retrieve lines from read_data via a generator
        # so that separate calls to readline, read, and readlines
        # are properly interleaved
        sep = b"\n" if isinstance(read_data, bytes) else "\n"
        data_as_list = [item + sep for item in read_data.split(sep)]

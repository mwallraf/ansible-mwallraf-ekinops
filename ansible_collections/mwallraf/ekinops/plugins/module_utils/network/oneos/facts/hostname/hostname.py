...
from ansible_collections.mwallraf.ekinops.plugins.module_utils.network.oneos.argspec.hostname.hostname import (  # noqa:E501
    HostnameArgs,
)


class HostnameFacts(object):
    """The oneos hostname facts class"""

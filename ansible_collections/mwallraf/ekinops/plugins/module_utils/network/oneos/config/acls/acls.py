                        ...
                        if acl.get("aces"):
                            ...
                            for ace in acl.get(
                                ...
                                if acl.get("acl_type") == "standard":
                                    # some oneos output give destination any
                                    # for standard ACL
                                    if ace.get("destination"):
                                        if ace["destination"].get("any"):
                                            ace.pop("destination")
                                ...
                                elif acl.get("acl_type") == "extended":
                                    proto_options = ace.get(
                                        "protocol_options", {}
                                    )
                                    if not proto_options.get("protocol"):
                                        ace.setdefault("protocol_options", {})
                                        ace["protocol_options"][
                                            "protocol"
                                        ] = "ip"
